    ...
    <div className="bg-slate-100 dark:bg-slate-800 border border-slate-300 dark:border-slate-700 rounded-xl shadow-2xl p-6 w-full max-w-4xl m-4 text-slate-800 dark:text-white relative flex flex-col animate-slide-up max-h-[90vh] overflow-y-auto scrollbar-hide">
      ...
      <div className="w-full mt-8 p-4 border-t-2 border-slate-300 dark:border-slate-600">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-end">
              <div>
                  <label htmlFor="alcoholA" className="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-2">
                      الكحول 1: ذرات الكربون
                  </label>
                  <div className="flex items-center gap-3">
                      <input
                          ...
                          className="flex-grow h-2 bg-slate-200 dark:bg-slate-700 rounded-lg appearance-none cursor-pointer accent-cyan-500"
                      />
                      <span className="font-bold text-lg bg-cyan-100 dark:bg-cyan-900/50 text-cyan-700 dark:text-cyan-300 px-3 py-1 rounded-lg min-w-[3rem] text-center">
                          {newCarbonCountA}
                      </span>
                  </div>
              </div>
              <div>
                  <label htmlFor="alcoholB" className="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-2">
                       الكحول 2: ذرات الكربون
                  </label>
                  <div className="flex items-center gap-3">
                      <input
                          id="alcoholB"
