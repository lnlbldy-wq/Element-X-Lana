        ...
        <div className="flex-grow overflow-y-auto scrollbar-hide px-6 py-5 space-y-6 animate-fade-in" key={activeTab}>
            ...
            {activeTab === 'advanced' && (
                <section className="grid grid-cols-1 gap-3">
                     ...
                     <PropertyRow label="القطبية وعزم الثنائي قطب" value={reaction.dipoleMoment || reaction.polarity} />
                     <PropertyRow label="فرق السالبية الكهربائية" value={reaction.electronegativityDifference} color="text-yellow-400" />
                     <PropertyRow label="طاقة الرابطة المتوسطة" value={reaction.bondEnthalpy} color="text-rose-400" />
                     <PropertyRow label="الاستقرار الحراري" value={reaction.thermalStability} color="text-orange-400" />
                     <PropertyRow label="نصف قطر فان دير فالس" value={reaction.vanDerWaalsRadius} />
