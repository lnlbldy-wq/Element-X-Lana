...
export const Header: React.FC<HeaderProps> = ({ theme, setTheme }) => {
  return (
    <header className="bg-white/80 dark:bg-gray-900/50 backdrop-blur-md border-b border-slate-200 dark:border-slate-700 p-4 shadow-lg flex items-center justify-between z-20">
